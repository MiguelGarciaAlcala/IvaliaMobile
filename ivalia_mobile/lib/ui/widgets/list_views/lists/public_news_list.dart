...
class PublicNewsList extends StatelessWidget {
  final List<New> items;
  final RefreshCallback onRefresh;

  const PublicNewsList({required this.items, required this.onRefresh,  Key? key}) : super(key: key);
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return PaddedWidget.only(
            ...
            child: PublicNewItem(items[index]),
          );
        },
      ),
    );
