...
import 'package:ivalia_mobile/ui/widgets/list_views/items/admin_file_item.dart';
...
class AdminFilesList extends StatelessWidget {
  final RefreshCallback onRefresh;
  final List<FileResource> items;

  const AdminFilesList({required this.items, required this.onRefresh, Key? key}) : super(key: key);
              ...
              child: PaddedWidget.only(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return AdminFileItem(items[index]);
                  },
                )
              )
            )
